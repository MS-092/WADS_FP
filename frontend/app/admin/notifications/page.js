...
export default function AdminNotificationsPage() {
  ...
  const urgentNotifications = notifications.filter((n) => n.type === "urgent" || n.priority === "high")
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        <TabsContent value="all" className="space-y-4">
          <AdminNotificationList notifications={notifications} onMarkAsRead={markAsRead} formatTimeAgo={formatTimeAgo} />
        </TabsContent>

        <TabsContent value="unread" className="space-y-4">
          <AdminNotificationList notifications={unreadNotifications} onMarkAsRead={markAsRead} formatTimeAgo={formatTimeAgo} />
        </TabsContent>

        <TabsContent value="urgent" className="space-y-4">
          <AdminNotificationList notifications={urgentNotifications} onMarkAsRead={markAsRead} formatTimeAgo={formatTimeAgo} />
        </TabsContent>

        <TabsContent value="read" className="space-y-4">
          <AdminNotificationList notifications={readNotifications} onMarkAsRead={markAsRead} formatTimeAgo={formatTimeAgo} />
        </TabsContent>
      </Tabs>
    </div>
  )
...
function AdminNotificationList({ notifications, onMarkAsRead, formatTimeAgo }) {
  ...
  const isUrgent = (notification) => {
    return notification.type === "urgent" || notification.priority === "high"
  }
